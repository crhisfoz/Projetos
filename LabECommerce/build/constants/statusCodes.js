...
exports.messageStatus = {
    ...
    FORBIDDEN: {
        status: 403,
        message: " Please verify if your ID was sent on headers authorization, it must be 'ADMIN' or 'NORMAL'. ",
    },
    ...
    NOT_IMPLEMENTED_PASSWORD: {
        status: 405,
        message: " PASSWORD already exists in database, please verify and try again",
    },
    ALREADY_EXISTS: {
        status: 409,
    ...
    MISSING_PARAMETERS: {
        status: 422,
        message: "Missing or incorrect information. Consult the documentation and correctly fill in the body of the sa request",
    },
